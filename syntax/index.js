...
var startServer = function (protocol, port) {
    if (port === port3000 || port === port3001) {
        console.log("".concat(protocol, "://localhost:").concat(port, "/"));
    }
    else {
...
var createAnimation = function (id, animName, timingFunc, duration, iteration) {
    ...
    console.log("".concat(animName, " ").concat(timingFunc, " ").concat(duration, "s ").concat(iteration));
};
